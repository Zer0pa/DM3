...
## F12 — 2026-04-25 playbook alignment keeps the DM3 license exception
...
The 2026-04-25 repo playbook and live-project ethos add a parser-facing
`## Upcoming Workstreams` section, stronger front-door category /
blocker prose, mandatory compliance audit, and packaging upper-bound
discipline. DM3 adopts those repo-shape rules while keeping the explicit
ethos exception that DM3 is separately licensed under
`LicenseRef-Zer0pa-DM3-RRL-1.0`, not SAL v7.0. The public surface now
